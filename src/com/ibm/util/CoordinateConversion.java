...
public class CoordinateConversion
{
  ...
  /**
   * added by Philip Kuryloski
   */
  public UtmLocation latLon2UtmLocation(double latitude, double longitude)
  {
    LatLon2UTM c = new LatLon2UTM();
    return c.convertLatLonToUtmLocation(latitude, longitude);
  }
  ...
  private class LatLon2UTM
  {
    ...
    /**
     * Method introduced by Philip Kuryloski
     * 
     * @see com.ibm.util.UtmLocation
     */
    public UtmLocation convertLatLonToUtmLocation(double latitude, double longitude)
    {
      validate(latitude, longitude);
      ...
      return new UtmLocation(longZone, latZone, _easting, _northing);
    }
