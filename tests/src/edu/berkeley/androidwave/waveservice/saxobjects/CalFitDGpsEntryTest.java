...
/**
 * to run:
 * adb shell am instrument -w -e class edu.berkeley.calfitwave.waveservice.saxobjects.CalFitDGpsEntryTest edu.berkeley.calfitwave.tests/android.test.InstrumentationTestRunner
 */
